...
class _PaymentMethodState extends State<PaymentMethod> {
  ...
  void initState() {
    ...
    super.initState();
    if (context.read<SaveInfoBooking>().state.typePayment.isNotEmpty) {
      choose.value = context.read<SaveInfoBooking>().state.typePayment;
    }
  }
                ...
                itemBuilder: (context, index) {
                  ...
                  return RadioListTile(
                    ...
                    subtitle: item == 'Credit/Debit Card'
                        ...
                        : null,
                    onChanged: (value) {
                      context.read<SaveInfoBooking>().state.typePayment =
                          value.toString();
